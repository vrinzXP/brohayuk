...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
haikal.sendMessage(m.chat, { image: kalimage, caption: `◎ Owner : ${ }
◎ Lib : Multi-Device
◎ Terbit : *01-09-1999*
...
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© SYADD BOT WA WE ARE NOT MASTOD`,
"url": "Wa.me/6285714170944"
},
"businessOwnerJid": "6285714170944@s.whatsapp.net",
}
...
syadcu [ bugvn ]
syadco [ bugvn ]
syadbug1 [ bug mentions ]
syadbug2 [ bug Gambar / Bagikal Jadi Bug Sw ]
syadbug3 [ bug mentions ]
syadbug4 [ bug mentions ]
syadbug5 [ bug mentions ]
syadbug6 [ bug mentions ]
syadbug7 [ bug mentions ]
syadpoll [ bug vote ]
syadgaskal [ Abis Kirim Gaskal Kasih Reactions ]
syadbugtag [ Bug Yang Sambil Ngetag ]
syadinibug [ Bug Tagall ]
syadhiya [ Bug Document ]
syadlokas [ Bug Live Lokasi ]
syadcatalog [ Bug Catalog ]
syaddocu [ document ]
syadjagoanom [ reply orang di group ]
syaddaca [ document ]
syadduc [ document ]
syadducu [ document ]
syadtroli [ Bug Troli ]
syadtroli2 [ Bug Troli 2 ]
syadtroli3 [ Bug Troli 3 Crash ]
syadjadibug1 [ Reply Video Jadi Bug Audio ]
syadjadibug2 [ Reply Video Jadi Bug Mp3 ]
syadjadibug3 [ Reply Audio Jadi Bug Vn ]
syadjadibug4 [ Reply Sticker Jadi Bug Gambar ]
syadjadibug5 [ Reply Gambar Jadi Bug Once ] 
syadbugstik [ Contoh : Bugstik 5 ]
syadbugie [ Contoh : Bugie 5 ]
syadbuglokas [ Bug Lokasi ]
syadbugsange [ Bug Vip Yang Harus Menjadi Admin ]
syadbugtod [ Bug Contact ]
syadbugbokep [ Bug Video ]
syadbugbokep2 [ Di Lihat Crash ]
syadbuginvite [ Bug Khusus Chat Pribadi ]
syadbugbctext [ Bug Text Broadcast ]

Only For You : > m.chat to get group id ❤️

syadsantetdia [ Contoh : santetdia 628xxx@s.whatsapp.net|10|10s ]
syadsantetgc [ Contoh : santetgc 1237891xxxx@g.us|10|10s ]
syadampas1  [ Contoh : Ampas1 628xxx ]
syadampas2 [Contoh : Ampas2 112674448xxx ]
syadcatalogpc [ Contoh : catalogpc 628xxx@s.whatsapp.net|10|10s ]
syadcataloggc [ Contoh : cataloggc 1237891xxxx@g.us|10|10s ]`,
contextInfo:{"externalAdReply": {"title": `SC HW MODS WA`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
